...
$( document ).ready( function() {
    ...
    $( 'input[ type="name" ]' ).focus( function() { $( this ).removeClass( 'invalid' ) } );
    $( 'input[ type="email" ]' ).focus( function() { $( this ).removeClass( 'invalid' ) } );
    $( 'textarea' ).focus( function() { $( this ).removeClass( 'invalid' ) } );
